    ...
    return(
        <div className = "app-container">
            <div className = "card-container">
                <img src = {imageUrl} className="image1" alt = {imageAltText}/>
                <h1 className = "heading">Nature Photography</h1>
                <p className = "description">Nature Photography by Rahul</p>
                <ul className="thumbnail-list">
                    {imagesList.map(eachImage=>(<ThumbnailItem key = {eachImage.id} imageDetails ={eachImage} isActive = {activeThumbnailId === eachImage.id} setActiveThumbnailId = {this.setActiveThumbnailId}
